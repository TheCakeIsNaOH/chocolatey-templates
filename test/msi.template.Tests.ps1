Describe 'MSI Template' {
    BeforeAll {
        $workDirectory = "$PSScriptRoot\..\_output\tests\msi.template"
    ...
    Context 'New package without any additional arguments' {
        BeforeDiscovery {
            ...
            $nuspecValues = @(
                ...
                @{ Name = 'tags'; Value = 'test-extension extension msi SPACE_SEPARATED' }
        ...
        BeforeAll {
            ...
            choco new $identifier --outputdirectory "$workDirectory" --template 'msi'
        }
    ...
    Context 'New package with custom extension identifier' {
        BeforeDiscovery {
            ...
            $nuspecValues = @(
                ...
                @{ Name = 'projectUrl'; Value = 'https://marketplace.visualstudio.com/items?itemName=gep13.chocolatey-msi' }
                @{ Name = 'licenseUrl'; Value = 'https://marketplace.visualstudio.com/items/gep13.chocolatey-msi/license' }
                @{ Name = 'tags'; Value = 'test-extension-id extension msi SPACE_SEPARATED' }
            )
        }
        ...
        BeforeAll {
            ...
            choco new $identifier --outputdirectory "$workDirectory" --template 'msi' extensionId="gep13.chocolatey-msi"
        }
...
Install-VsCodeExtension -extensionId 'gep13.chocolatey-msi'
"@
        }
...
Uninstall-VsCodeExtension -extensionId 'gep13.chocolatey-msi'
"@
        }
        ...
        Context 'New package with uppercase identifier' {
            BeforeDiscovery {
                $nuspecValues = @(
                    ...
                    @{ Name = 'tags'; Value = 'test-kebab-title-case extension msi SPACE_SEPARATED' }
                )
            }
        ...
        Context 'New package using argument <Argument>' -ForEach @(
            ...
            BeforeAll {
                ...
                choco new $identifier --template 'msi' --outputdirectory "$workDirectory" $Argument
            }
